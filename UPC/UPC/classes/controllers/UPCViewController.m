...
- (void)viewDidLoad
{
    self.responsiveURLs = [NSDictionary dictionaryWithObjectsAndKeys:@"http://m.upc.edu/graus", @"graus", @"http://m.upc.edu/masters", @"masters", @"http://m.atenea.upc.edu", @"atenea", nil];
